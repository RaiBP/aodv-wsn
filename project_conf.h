...
/*MAXTIME STTING*/
#define MAX_DISCOVERY_TIME 5   		// maximum time to obtain route to a destination
...
#define MAX_ACK_WAIT_TIME 5        // Maximum time for a data package to remain in the ack waiting table before being discarded
